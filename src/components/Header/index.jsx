...
export const Header = () => {
  return (
    <div className=''>
      <div className={`h-[166px] ${s.header}`}>
        <div className="container mx-auto pt-[13px] flex justify-between">
          <div className='flex'>
            ...
            <h3 className={`${s.header_location}`}>Хабаровск</h3>
          </div>
        ...
        <div className={`container mx-auto mt-[17px]`}>
          <div className="flex gap-[17px]  justify-between ">
            <div className="flex gap-[17px]">
              <div className={`${s.header_techno_block} flex  `}>
                <svg className="pl-[8px]" xmlns="http://www.w3.org/2000/svg" width="62" height="67" viewBox="0 0 62 67" fill="none">
                ...
                <p className={`${s.header_blosks}`}>
                  Техночел
                </p>
              </div>
              <div className={`${s.header_catalog_block}`}>
                <p className={`${s.header_catalog}`}>Каталог</p>
              </div>
            </div>
            <div className='relative '>
              <input placeholder="Поиск по сайту" type="text" className={`${s.header_input}`} />
              <svg className="absolute right-[30px] top-[22px]" xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
            ...
            <div className='flex justify-between align-center gap-[50px] '>
              <div >
